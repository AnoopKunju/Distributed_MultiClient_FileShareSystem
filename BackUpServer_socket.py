...
lbl_title = tk.Label(topFrame, text="Welcome to BACKUP FILE Transfer").pack(side= tk.LEFT)
...
def handle_client(conn, addr):
    ...
    while True:
        try:
            ...
            if cmd == "CONNECTBACKUP":
                conn.send("BACKUPACCEPTED@".encode(FORMAT))
                ...
                with open("Lexicon/lexicon_backup.txt","r") as f:      #reading words in lexicon
                    lexi_string += f.read()
                ...
                print("CLOSING CONNECTION IN BACKUP")
